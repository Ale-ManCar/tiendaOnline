...
export function ConfirmationPage() {
  ...
  if (!order || (currentUser?.role !== 'admin' && order.userId !== currentUser?.id)) return <div className="container not-found"><h1>Pedido no encontrado</h1><Link className="button primary" to="/">Volver al inicio</Link></div>;
